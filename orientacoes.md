...
cd projeto_02_analise_vendas_loja
...
git commit -m "Initial commit: Sistema de Análise de Vendas de Loja"
```
...
3. **Configure o repositório:**
   - **Repository name**: `projeto_02_analise_vendas_loja`
   - **Description**: "Sistema de Análise de Vendas de Loja - Projeto do Módulo 1"
...
git remote add origin https://github.com/SEU_USUARIO/projeto_02_analise_vendas_loja.git
...
```
projeto_02_analise_vendas_loja/
├── README.md                 # Documentação principal
├── orientacoes.md           # Este arquivo
├── .gitignore               # Arquivos ignorados pelo Git
├── requirements.txt         # Dependências (opcional)
├── sistema_vendas.py      # Código principal
